...
double bayes_mvr_ridge_scaled_X (const vec& b, const mat& S0, const mat& S, const mat& S1, 
                                 const mat& SplusS0_chol, const mat& S_chol, 
                                 double ldetSplusS0_chol, double ldet_chol,
                                 vec& mu1);
...
// [[Rcpp::depends(RcppArmadillo)]]
// [[Rcpp::export]]
List bayes_mvr_ridge_scaled_X_rcpp (const arma::vec& b, const arma::mat& S0, const arma::mat& S, const arma::mat& S1, 
                                    const arma::mat& SplusS0_chol, const arma::mat& S_chol, 
                                    double ldetSplusS0_chol, double ldet_chol) {
...
double bayes_mvr_ridge_scaled_X (const vec& b, const mat& S0, const mat& S, const mat& S1, 
                                 const mat& SplusS0_chol, const mat& S_chol, 
                                 double ldetSplusS0_chol, double ldetS_chol,
                                 vec& mu1) {
